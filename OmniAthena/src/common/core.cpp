...
static void display_title(void) {
	...
	ShowMessage("" CL_PASS " " CL_BT_WHITE "            OmniAthena Development Team presents         " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "                                                         " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD " +++++ +++++ +  + +++ +++++ +++++ +   + +++++ +  + +++++ " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD " +   + + | + ++ +  |  +   +   |   +___+ +___  ++ + +   + " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD " +   + + | + + ++  |  +---+   |   +   + +     + ++ +---+ " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD " +++++ +   + +  + +++ +   +   |   +   + +++++ +  + +   + " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "                                                         " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "    " CL_GREEN "               http://www.omni-rathena.com               " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "                                                         " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
